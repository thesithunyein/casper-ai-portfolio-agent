...
export const WalletConnect = () => {
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      {/* Card */}
      <div className="relative bg-white border border-border rounded-xl p-6 sm:p-8 transition-all duration-500 hover:border-border-strong card-lift shadow-sm">
        {/* Icon + Title */}
        <div className="text-center mb-6">
          ...
          <h2 className="text-xl font-semibold text-slate-900 mb-1">Connect Your Wallet</h2>
          <p className="text-sm text-slate-500">Enter your Casper public key to analyze your portfolio</p>
        </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-4 py-3 bg-slate-50 border text-slate-900 placeholder-slate-400 focus:outline-none transition-all duration-300 font-mono text-sm rounded-lg ${
                  showError
          ...
          <button
            onClick={handleDemo}
            className="w-full px-4 py-2.5 bg-slate-50 border border-border text-slate-600 text-sm font-medium rounded-xl hover:bg-slate-100 hover:border-border-strong hover:text-slate-900 transition-all duration-300 active:scale-[0.98]"
          >
      ...
      {/* Footer badges */}
      <div className="mt-5 flex items-center justify-center gap-6 text-[10px] font-mono text-slate-400">
