...
const ROADMAP: RoadmapItem[] = [
  ...
  {
    phase: 'Q3 2026',
    title: 'Live x402 Facilitator + RWA oracle writes',
    desc: 'HTTP facilitator settle path plus on-chain T-bill / PAXG / ONDO price posts from the Oracle agent.',
    status: 'in-progress',
  },
  {
    phase: 'Q3 2026',
  ...
  {
    phase: 'Q4 2026',
    title: 'CEP-18 + deeper MCP yield mesh',
    desc: 'Multi-token portfolios and CSPR.trade MCP-driven yield routing at production depth.',
    status: 'upcoming',
  },
  {
    phase: 'Q1 2027',
    title: 'Mobile PWA + multi-agent mesh',
    desc: 'Casper Wallet / Ledger, and specialized agents coordinating via x402.',
    status: 'upcoming',
  },
]
